...
echo $dbconnect->connect_error;
 //hypervisor 1
$query = "SELECT sum(max_cpu) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 3) ";
$query1 = "SELECT sum(vm_memory) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 3) ";
$query2 = "SELECT sum(storage) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 3) ";
...
$row2 = mysqli_fetch_assoc($res2);
   ...
   //hypervisor2
$query3 = "SELECT sum(max_cpu) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 4) ";
$query4 = "SELECT sum(vm_memory) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 4) ";
$query5 = "SELECT sum(storage) FROM vm_table WHERE esxi_id IN (SELECT esxi_id FROM esxi_table e WHERE e.esxi_id = 4) ";
//$res = $dbconnect-> query($query);
