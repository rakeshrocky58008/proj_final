...
//vm1
$ftquery="SELECT count(ft) from vm_table where esxi_id=5 and ft=1";
$ftquery1="SELECT count(ft) from vm_table where esxi_id=5 and ft=0";
$query = "SELECT max_cpu FROM vm_table where vm_id=13";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=13";
$query2 = "SELECT storage FROM vm_table where vm_id=13";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=14";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=14";
$query5 = "SELECT storage FROM vm_table where vm_id=14";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=15";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=15";
$query8 = "SELECT storage FROM vm_table where vm_id=15";
//$res = $dbconnect-> query($query);
