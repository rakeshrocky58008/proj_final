...
$query = "SELECT max_cpu FROM vm_table where vm_id=19";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=19";
$query2 = "SELECT storage FROM vm_table where vm_id=19";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=20";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=20";
$query5 = "SELECT storage FROM vm_table where vm_id=20";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=21";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=21";
$query8 = "SELECT storage FROM vm_table where vm_id=21";
//$res = $dbconnect-> query($query);
