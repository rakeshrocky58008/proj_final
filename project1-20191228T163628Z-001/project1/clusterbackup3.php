...
$query = "SELECT max_cpu FROM vm_table where vm_id=25";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=25";
$query2 = "SELECT storage FROM vm_table where vm_id=25";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=26";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=26";
$query5 = "SELECT storage FROM vm_table where vm_id=26";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=27";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=27";
$query8 = "SELECT storage FROM vm_table where vm_id=27";
//$res = $dbconnect-> query($query);
