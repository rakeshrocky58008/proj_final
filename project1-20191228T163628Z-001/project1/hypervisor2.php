...
//vm1
$ftquery="SELECT count(ft) from vm_table where esxi_id=2 and ft=1";
$ftquery1="SELECT count(ft) from vm_table where esxi_id=2 and ft=0";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=5";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=5";
$query5 = "SELECT storage FROM vm_table where vm_id=5";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=6";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=6";
$query8 = "SELECT storage FROM vm_table where vm_id=6";
//$res = $dbconnect-> query($query);
