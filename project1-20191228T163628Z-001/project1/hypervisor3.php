...
$query = "SELECT max_cpu FROM vm_table where vm_id=7";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=7";
$query2 = "SELECT storage FROM vm_table where vm_id=7";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=8";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=8";
$query5 = "SELECT storage FROM vm_table where vm_id=8";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=9";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=9";
$query8 = "SELECT storage FROM vm_table where vm_id=9";
//$res = $dbconnect-> query($query);
