...
//vm1
$ftquery="SELECT count(ft) from vm_table where esxi_id=6 and ft=1";
$ftquery1="SELECT count(ft) from vm_table where esxi_id=6 and ft=0";
$query = "SELECT max_cpu FROM vm_table where vm_id=16";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=16";
$query2 = "SELECT storage FROM vm_table where vm_id=16";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=17";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=17";
$query5 = "SELECT storage FROM vm_table where vm_id=17";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=18";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=18";
$query8 = "SELECT storage FROM vm_table where vm_id=18";
//$res = $dbconnect-> query($query);
