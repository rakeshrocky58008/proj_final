...
//vm1
$ftquery="SELECT count(ft) from vm_table where esxi_id=3 and ft=1";
$ftquery1="SELECT count(ft) from vm_table where esxi_id=3 and ft=0";
$query = "SELECT max_cpu FROM vm_table where vm_id=22";
$query1 = "SELECT vm_memory FROM vm_table where vm_id=22";
$query2 = "SELECT storage FROM vm_table where vm_id=22";
...
//vm2
$query3 = "SELECT max_cpu FROM vm_table where vm_id=23";
$query4 = "SELECT vm_memory FROM vm_table where vm_id=23";
$query5 = "SELECT storage FROM vm_table where vm_id=23";
//$res = $dbconnect-> query($query);
...
//vm3
$query6 = "SELECT max_cpu FROM vm_table where vm_id=24";
$query7 = "SELECT vm_memory FROM vm_table where vm_id=24";
$query8 = "SELECT storage FROM vm_table where vm_id=24";
//$res = $dbconnect-> query($query);
